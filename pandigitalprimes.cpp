...
ll check(std::vector<ll> v)
{
	...
	{
		sum1 =0 ;
		//cout << v[0] << "this is v[0] \n" ;
		//cout << v[1] << "this is v[1] \n" ;
		//cout << v.size() << "this is the sizee of the vector \n" ;
		for(ll i=0;i<v.size();i++)
		{
			sum1 += v[v.size()-1-i]*pow(10,i) ;
		}
		//cout << sum1 << "this is the sum in each permutation \n" ;
		if(is_prime(sum1))
		{
			if(sum1>best)
				best=sum1 ;
		}
		//cout << best << "this is best in each operation \n" ;
